...
#| fig-cap: Density plot of tertiary limphatic structures around meninges by phenotype (1, 2 or 3). Colour indicates the fraction of structures found in each pixel. Rows correspond to a mice group based on sex and age category, whereas columns represent phenotypes.
#| fig-width: 10
#| fig-asp: 1
ggplot(df, aes(x = X, y = Y)) +
  lims(x = c(-5000, 5000), y = c(-2500, 10100)) +
